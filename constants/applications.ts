 ...
 */
export const APPLICATION_OPEN_DATETIME = "Mar 6 2021 00:00:00 EST";

/**
 * Application close datetime
 * Format: MMM DD YYYY HH:MM:SS TZ
 */
export const APPLICATION_CLOSE_DATETIME = "Mar 19 2021 23:59:59 EST";

/**
 * Date that invites are sent out for interviews
 * Format: MMM DD
 */
export const INVITE_DATE = "Mar 23";
