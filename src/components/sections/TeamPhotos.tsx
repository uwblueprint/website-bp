...
const PHOTOS = [
  { src: "/img/socials/f25-internal-murder-mystery.webp", alt: "Blueprint team at murder mystery social" },
  { src: "/img/socials/w24-eaf-escape-room.webp", alt: "Blueprint team at escape room" },
  { src: "/img/socials/f19-celebratory-burrito.webp", alt: "Blueprint design team social" },
  { src: "/img/socials/w24-sistema-kbbq.webp", alt: "Blueprint team dinner" },
  { src: "/img/socials/s24-eaf-toronto.webp", alt: "Blueprint team in Toronto" },
] as const;

/** Each row: left cell span + photo index, right cell span + photo index (12-col grid, gap-4). */
const ROWS: { left: { span: 8 | 4; index: number }; right: { span: 8 | 4; index: number } }[] = [
          ...
          >
            <FadeUp
              ...
              className={cn(
                ...
                row.left.span === 8 ? "min-[800px]:col-span-8" : "min-[800px]:col-span-4",
              )}
            >
              <Image
            ...
            <FadeUp
              ...
              className={cn(
                "relative min-h-0 overflow-hidden max-[799px]:aspect-square",
                row.right.span === 8 ? "min-[800px]:col-span-8" : "min-[800px]:col-span-4",
              )}
            >
              <Image
