...
const ROW_1: Photo[] = [
  {
    src: "/img/socials/w26-mfsn-pottery.webp",
    label: "W26 MFSN tries their hands at pottery",
  },
  {
    src: "/img/socials/f25-design-star.webp",
    label: "F25 Design team really coming together",
  },
  {
    src: "/img/socials/f25-internal-murder-mystery.webp",
    label: "F25's murder mystery night (best internal ever?)",
  },
  {
    src: "/img/socials/f25-pumpkin-1.webp",
    label: "F25 [unknown pumpkin design]",
  },
  {
    src: "/img/socials/f25-pumpkin-2.webp",
    label: "F25 pumpkin carving social",
  },
  {
    src: "/img/socials/f25-pumpkin-3.webp",
    label: "F25 David judges the best batch",
  },
  {
    src: "/img/socials/s24-eaf-toronto.webp",
    label: "S24 EAF team escapes Toronto",
  },
  {
    src: "/img/socials/w24-design-team.webp",
    label: "W24 Design team takes on kbbq",
  },
  {
    src: "/img/socials/w24-eaf-escape-room.webp",
    label: "W24 EAF team escapes KW",
  },
  {
    src: "/img/socials/w24-eaf-mario.webp",
    label: "W24 EAF team takes on Mario Kart",
  },
];

const ROW_2: Photo[] = [
  {
    src: "/img/socials/w24-de-design.webp",
    label: "W24 DE design team at EOT (end of term)",
  },
  { src: "/img/socials/w24-de-zoom.webp", label: "W24 DE team loves zoom" },
  {
    src: "/img/socials/w24-llsc-codenames.webp",
    label: "W24 LLSC plays codenames",
  },
  {
    src: "/img/socials/w24-marillac-4-life.webp",
    label: "W24 · Marillac · 4 Life",
  },
  {
    src: "/img/socials/w24-marillac-bowling.webp",
    label: "W24 · Marillac · bowling",
  },
...
const ROW_3: Photo[] = [
  {
    src: "/img/socials/w23-eteam-climb.webp",
    label: "W23 · E-Team · climbing",
  },
  {
    src: "/img/socials/w23-general-social.webp",
    label: "W23 · Internal · general social",
  },
  {
    src: "/img/socials/w23-jumpmath-toronto.webp",
    label: "W23 · JumpMath · Toronto trip",
  },
  { src: "/img/socials/f23-cas-bike.webp", label: "F23 · CAS · biking" },
  { src: "/img/socials/f23-cas-raft.webp", label: "F23 · CAS · rafting" },
  {
    src: "/img/socials/f23-cas-spikeball.webp",
    label: "F23 · CAS · spikeball",
  },
  { src: "/img/socials/f23-show.webp", label: "F23 · Internal · show night" },
  {
    src: "/img/socials/s22-bot.webp",
    label: "S22 · Internal · bot competition",
  },
  {
    src: "/img/socials/w22-gm.webp",
    label: "W22 · Internal · general meeting",
  },
];

const ROW_4: Photo[] = [
  {
    src: "/img/socials/w22-gm-1.webp",
    label: "W22 · Internal · general meeting",
  },
  { src: "/img/socials/w22-rhs-burgers.webp", label: "W22 · RHS · burgers" },
  {
    src: "/img/socials/f21-community-fridge.webp",
    label: "F21 · Community Fridge · volunteer",
  },
  { src: "/img/socials/w20-reunion.webp", label: "W20 · Internal · reunion" },
  {
    src: "/img/socials/s19-data-assist-spooderman.webp",
    label: "S19 · Data Assist · Spiderman",
  },
  {
    src: "/img/socials/w19-foodbank.webp",
    label: "W19 · Food Bank · volunteer",
  },
  { src: "/img/socials/w19-snowday.webp", label: "W19 · Internal · snow day" },
  {
    src: "/img/socials/f19-eteam-pumpkins.webp",
    label: "F19 · E-Team · pumpkins",
  },
  {
    src: "/img/socials/f19-celebratory-burrito.webp",
    label: "F19 · Internal · celebratory burrito",
  },
];
