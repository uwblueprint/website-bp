...
const HighlightedProjects: FC = () => {
  return (
    <section className="content flex flex-col md:items-center py-24 pr-0 md:pr-4">
      ...
      <hr className="hidden md:block w-20 mt-4 mb-24 text-blue" />
      <div className="flex overflow-x-auto space-x-4 md:space-x-0 last:pr-4 md:last:pr-0 pb-4 md:grid md:grid-cols-2 md:grid-rows-2 md:gap-10 ">
