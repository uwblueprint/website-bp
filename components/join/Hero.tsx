...
const Hero: FC = () => {
  return (
    <header className="mt-36 md:mt-0 md:h-[560px] w-full flex justify-around items-center bg-no-repeat bg-bottom bg-cover md:bg-join-hero pb-8 md:pb-0">
      <div className="max-w-6xl flex flex-col md:flex-row px-4">
        <div className="md:-mt-8 lg:mt-8 mb-6 md:mb-0">
          <h1 className="text-blue-100 mb-4 md:mb-0 md:text-white">
            Join our Team
          </h1>
          <div className="space-y-6">
            <p className="md:text-white text-xl w-full lg:w-2/3">
