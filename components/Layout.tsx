...
export const VStack = ({ className, children }: any) => {
  return <_VStack className={className}>{children}</_VStack>;
};

export const HStack = ({ className, children }: any) => {
  return <_HStack className={className}>{children}</_HStack>;
};

export const Centered = ({ className, children }: any) => {
...
export const CenteredVStack = ({ className, children }: any) => {
  return <_CenteredVStack className={className}>{children}</_CenteredVStack>;
};

export const CenteredHStack = ({ className, children }: any) => {
