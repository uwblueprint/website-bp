    ...
    <div>
      ...
      <Container>
        <Section>
          ...
          <HStack>
            <LandingContent>
              <LandingTitle>{resource.NONPROFIT_LANDING_TITLE}</LandingTitle>
              <LandingText>{resource.NONPROFIT_LANDING_TEXT}</LandingText>
        ...
        <Section>
          <SectionContent>
            <LandingTitle>{resource.NONPROFIT_PROCESS_TITLE}</LandingTitle>
            <HStack>
              <div style={{ width: "100%" }}>
                <VStack>
        ...
        <Section>
          <SectionContent>
            <LandingTitle>{resource.NONPROFIT_FAQ_TITLE}</LandingTitle>
