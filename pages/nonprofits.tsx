          ...
          <HStack>
            <LandingContent>
              ...
              <LandingText>
                ...
                technical problems for nonprofit organizations - all free of
                charge.
              </LandingText>
                  ...
                  return (
                    <HStack>
                      <div style={{ padding: "25px" }}>
                        <LandingTitle>{idx + 1}</LandingTitle>
                      </div>
                      <div style={{ padding: "25px" }}>
                        <h6 style={{ fontWeight: 600 }}>{data.title}</h6>
                        <p style={{ width: "75%" }}>{data.explanation}</p>
                      </div>
                    </HStack>
                  );
                })}
                ...
                <HStack>
                  <div style={{ width: "250px" }}>
                    ...
                    <p>
                      ...
                      improvements on the product based on the feedback received
                      from user testing. This phase is designed to completely
                      finish the product so that it is ready to be delivered to
                      the nonprofit. Upon completion, we meet with the nonprofit
                      to hand off the product and to figure out how maintenance
            ...
            <HStack>
              ...
              <VStack>
                <DecisionCriteriaDescription>
                  These are the primary criteria we use to determine project
                  fit:
                </DecisionCriteriaDescription>
                {criterion.map((data) => {
                  return (
