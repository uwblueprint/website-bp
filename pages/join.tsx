    ...
    <div>
      ...
      <Container>
        <Section>
          ...
          <HStack>
            <LandingContent>
              <LandingTitle>{resource.JOIN_LANDING_TITLE}</LandingTitle>
              <LandingText>{resource.JOIN_LANDING_TEXT}</LandingText>
            ...
            <Image src={landingGraphic} width="600px" height="500px" />
          </HStack>
        </Section>
        <Section>
          <SectionContent>
            <HStack>
              {/* <Image
                                ...
                                /> */}
              <VStack>
                <SectionTitle>{resource.JOIN_WHY_JOIN_TITLE}</SectionTitle>
                {whyJoinData.map((e) => {
                  return (
                    <div>
                      <Title>{e.title}</Title>
        ...
        <Section>
          <SectionContent>
            ...
            <HStack>
              <FaqHeader>{resource.JOIN_FAQ_APPLICATION_PROCESS}</FaqHeader>
              <FaqAccordion>
                <ControlledAccordions data={applicationFaq} />
              </FaqAccordion>
            </HStack>
            <HStack>
              <FaqHeader>{resource.JOIN_FAQ_ABOUT_OUR_TEAM}</FaqHeader>
              <FaqAccordion>
